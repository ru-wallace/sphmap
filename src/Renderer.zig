...
num_transit_segments: u32,
num_connection_segments: u32,

const Renderer = @This();

pub fn init(point_data: []const f32, index_data: []const u32, transit_street_split_idx: u32, connection_split_idx: u32) Renderer {
    ...
    return .{
        ...
        .g = g,
        .b = b,
        .num_street_segments = transit_street_split_idx,
        .num_transit_segments = connection_split_idx - transit_street_split_idx,
...
const BoundRenderer = struct {
    ...
    pub fn render(self: *const BoundRenderer, view_state: ViewState) void {
        ...
        self.inner.b.set(1.0);
        gui.glDrawElements(Gl.LINE_STRIP, @intCast(self.inner.num_transit_segments), Gl.UNSIGNED_INT, @intCast(self.inner.num_street_segments * 4));
